...
export class UrlResolverBase {
  ...
  @graphql.ResolveField(() => [RequestLog], { name: "requestLogs" })
  async findRequestLogs(
    @graphql.Parent() parent: Url,
    @graphql.Args() args: RequestLogFindManyArgs
  ): Promise<RequestLog[]> {
    const results = await this.service.findRequestLogs(parent.id, args);
  ...
  @graphql.ResolveField(() => [RequestParameter], { name: "requestParameters" })
  async findRequestParameters(
    @graphql.Parent() parent: Url,
    @graphql.Args() args: RequestParameterFindManyArgs
  ): Promise<RequestParameter[]> {
    const results = await this.service.findRequestParameters(parent.id, args);
